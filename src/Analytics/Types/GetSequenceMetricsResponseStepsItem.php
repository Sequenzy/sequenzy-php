...
class GetSequenceMetricsResponseStepsItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?array<GetSequenceMetricsResponseStepsItemFailedSubscribersItem> $failedSubscribers Up to 20 most recent failed subscribers for this step
     */
    #[JsonProperty('failedSubscribers'), ArrayType([GetSequenceMetricsResponseStepsItemFailedSubscribersItem::class])]
    ...
    /**
     * @var ?int $step Step number (1-indexed)
     */
    #[JsonProperty('step')]
    public ?int $step;
     ...
     * @param array{
     *   failedCount?: ?int,
     *   failedSubscribers?: ?array<GetSequenceMetricsResponseStepsItemFailedSubscribersItem>,
     *   nodeId?: ?string,
