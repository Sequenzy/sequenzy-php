...
class GetSequenceMetricsResponse extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?GetSequenceMetricsResponseEnrollmentSkipped $enrollmentSkipped Trigger matches where the contact could not be enrolled because they are unsubscribed or bounced. Defaults to the last 30 days when no explicit time range is provided.
     */
    #[JsonProperty('enrollmentSkipped')]
    public ?GetSequenceMetricsResponseEnrollmentSkipped $enrollmentSkipped;
    ...
    /**
     * @var ?array<GetSequenceMetricsResponseStepsItem> $steps Per-email-step metrics, ordered by position in the sequence
     */
    #[JsonProperty('steps'), ArrayType([GetSequenceMetricsResponseStepsItem::class])]
    public ?array $steps;
     ...
     *   enrollmentSkipped?: ?GetSequenceMetricsResponseEnrollmentSkipped,
     *   period?: ?string,
     *   recommendations?: ?RecommendationMetrics,
     *   sequenceId?: ?string,
     *   stats?: ?EngagementStats,
     *   steps?: ?array<GetSequenceMetricsResponseStepsItem>,
     *   success?: ?bool,
     * } $values
     */
