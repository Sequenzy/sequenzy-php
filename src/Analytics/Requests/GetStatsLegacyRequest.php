...
use Sequenzy\Analytics\Types\GetStatsLegacyRequestEmailType;
use DateTime;
use Sequenzy\Analytics\Types\GetStatsLegacyRequestPeriod;

class GetStatsLegacyRequest extends JsonSerializableType
{
    /**
     * @var ?value-of<GetStatsLegacyRequestEmailType> $emailType Structural email type filter. Use transactional for Send API and transactional SMTP traffic.
     */
    ...
    /**
     * @var ?value-of<GetStatsLegacyRequestPeriod> $period Sliding time window. Ignored when start/end are provided.
     */
    ...
    /**
     * @param array{
     *   emailType?: ?value-of<GetStatsLegacyRequestEmailType>,
     *   end?: ?DateTime,
     *   includeMachineEngagement?: ?bool,
     *   mailboxProvider?: ?string,
     *   period?: ?value-of<GetStatsLegacyRequestPeriod>,
     *   start?: ?DateTime,
     * } $values
     */
