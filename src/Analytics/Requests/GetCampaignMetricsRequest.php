...
use DateTime;
use Sequenzy\Analytics\Types\GetCampaignMetricsRequestPeriod;

class GetCampaignMetricsRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<GetCampaignMetricsRequestPeriod> $period Sliding time window. Ignored when `start` and `end` are provided.
     */
     ...
     *   period?: ?value-of<GetCampaignMetricsRequestPeriod>,
     *   start?: ?DateTime,
     * } $values
     */
