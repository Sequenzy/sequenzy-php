...
use Sequenzy\Subscribers\Types\UpdateByExternalIdPathSubscribersRequestCustomAttributesStrategy;
use Sequenzy\Subscribers\Types\UpdateByExternalIdPathSubscribersRequestStatus;

class UpdateByExternalIdPathSubscribersRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<UpdateByExternalIdPathSubscribersRequestCustomAttributesStrategy> $customAttributesStrategy How to apply customAttributes. replace replaces the existing public custom-attribute map. merge overwrites only provided keys and retains unspecified existing keys.
     */
    ...
    /**
     * @var ?string $externalId New external ID. Fails with 409 if another subscriber owns it.
     */
    ...
    /**
     * @var ?value-of<UpdateByExternalIdPathSubscribersRequestStatus> $status Setting `unsubscribed` performs the unsubscribe workflow.
     */
    #[JsonProperty('status')]
     ...
     *   customAttributesStrategy?: ?value-of<UpdateByExternalIdPathSubscribersRequestCustomAttributesStrategy>,
     *   email?: ?string,
     *   externalId?: ?string,
     *   firstName?: ?string,
     *   lastName?: ?string,
     ...
     *   phoneCountry?: ?string,
     *   smsConsent?: ?bool,
     *   status?: ?value-of<UpdateByExternalIdPathSubscribersRequestStatus>,
     *   tags?: ?array<string>,
     *   timezone?: ?string,
     * } $values
     */
