...
namespace Sequenzy\Subscribers\Tags;

use Psr\Http\Client\ClientInterface;
use Sequenzy\Core\Client\RawClient;
use Sequenzy\Subscribers\Tags\Requests\AddTagsRequest;
use Sequenzy\Subscribers\Tags\Types\AddTagsResponse;
...
use Sequenzy\Subscribers\Tags\Requests\RemoveTagsRequest;
use Sequenzy\Subscribers\Tags\Types\RemoveTagsResponse;
...
class TagsClient
{
     ...
     */
    public function add(AddTagsRequest $request, ?array $options = null): ?AddTagsResponse
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return AddTagsResponse::fromJson($json);
            }
     ...
     * @throws SequenzyApiException
     */
    public function remove(RemoveTagsRequest $request, ?array $options = null): ?RemoveTagsResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return RemoveTagsResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new SequenzyException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
