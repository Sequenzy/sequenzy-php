...
namespace Sequenzy\Feedback;

use Psr\Http\Client\ClientInterface;
use Sequenzy\Core\Client\RawClient;
use Sequenzy\Feedback\Requests\SubmitFeedbackRequest;
use Sequenzy\Feedback\Types\SubmitFeedbackResponse;
...
class FeedbackClient
{
     ...
     */
    public function submit(SubmitFeedbackRequest $request, ?array $options = null): ?SubmitFeedbackResponse
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return SubmitFeedbackResponse::fromJson($json);
            }
