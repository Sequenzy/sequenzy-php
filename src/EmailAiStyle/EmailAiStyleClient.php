...
namespace Sequenzy\EmailAiStyle;

use Psr\Http\Client\ClientInterface;
use Sequenzy\Core\Client\RawClient;
use Sequenzy\EmailAiStyle\Requests\ClearEmailAiStyleRequest;
use Sequenzy\Types\EmailAiStyleState;
...
use Sequenzy\EmailAiStyle\Requests\SaveEmailAiStyleRequest;

class EmailAiStyleClient
{
    /**
     * @var array{
     *   baseUrl?: string,
     ...
     * ```
     *
     * @param ClearEmailAiStyleRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * } $options
     * @return ?EmailAiStyleState
     * @throws SequenzyException
     * @throws SequenzyApiException
     */
    public function clearEmailAiStyle(ClearEmailAiStyleRequest $request, ?array $options = null): ?EmailAiStyleState
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return EmailAiStyleState::fromJson($json);
            }
     ...
     * @throws SequenzyApiException
     */
    public function getEmailAiStyle(?array $options = null): ?EmailAiStyleState
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * ```
     *
     * @param SaveEmailAiStyleRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws SequenzyApiException
     */
    public function saveEmailAiStyle(SaveEmailAiStyleRequest $request, ?array $options = null): ?EmailAiStyleState
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
