...
use Sequenzy\Widgets\Types\ListCaptureSubmissionsRequestFormat;

class ListCaptureSubmissionsRequest extends JsonSerializableType
{
    /**
    ...
    /**
     * @var ?value-of<ListCaptureSubmissionsRequestFormat> $format csv adds a CSV string for this page; the response remains JSON.
     */
     ...
     *   cursor?: ?string,
     *   field?: ?string,
     *   format?: ?value-of<ListCaptureSubmissionsRequestFormat>,
     *   limit?: ?int,
     *   value?: ?string,
     * } $values
     */
