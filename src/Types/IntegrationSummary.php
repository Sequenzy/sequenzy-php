...
class IntegrationSummary extends JsonSerializableType
{
    /**
     * @var ?value-of<IntegrationSummaryCategory> $category Provider category, or null for a provider with no catalog entry.
     */
    ...
    /**
     * @var ?string $name Display name for the provider, falling back to the raw provider id.
     */
    #[JsonProperty('name')]
    public ?string $name;
    ...
    /**
     * @param array{
     *   category?: ?value-of<IntegrationSummaryCategory>,
