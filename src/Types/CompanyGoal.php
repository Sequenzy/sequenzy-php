...
class CompanyGoal extends JsonSerializableType
{
    /**
     * @var ?value-of<CompanyGoalAttributeCondition> $attributeCondition
     */
    ...
    /**
     * @var ?value-of<CompanyGoalScope> $scope
     */
    #[JsonProperty('scope')]
    public ?string $scope;
    ...
    /**
     * @var ?value-of<CompanyGoalTriggerType> $triggerType
     */
    ...
    /**
     * @param array{
     *   attributeCondition?: ?value-of<CompanyGoalAttributeCondition>,
     ...
     *   isActive?: ?bool,
     *   name?: ?string,
     *   scope?: ?value-of<CompanyGoalScope>,
     *   triggerEventName?: ?string,
     *   triggerTagName?: ?string,
     *   triggerType?: ?value-of<CompanyGoalTriggerType>,
     * } $values
     */
