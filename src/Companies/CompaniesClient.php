...
namespace Sequenzy\Companies;

use Psr\Http\Client\ClientInterface;
use Sequenzy\Core\Client\RawClient;
use Sequenzy\Companies\Requests\CreateCompaniesRequest;
use Sequenzy\Companies\Types\CreateCompaniesResponse;
...
use Sequenzy\Companies\Types\GetCompaniesResponse;
use Sequenzy\Companies\Types\ListCompaniesResponse;
use Sequenzy\Companies\Requests\UpdateCompaniesRequest;
use Sequenzy\Companies\Types\UpdateCompaniesResponse;
...
class CompaniesClient
{
    ...
    public function create(CreateCompaniesRequest $request, ?array $options = null): ?CreateCompaniesResponse
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return CreateCompaniesResponse::fromJson($json);
            }
     ...
     * @throws SequenzyApiException
     */
    public function get(string $companyId, ?array $options = null): ?GetCompaniesResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
     ...
     * @throws SequenzyApiException
     */
    public function list(?array $options = null): ?ListCompaniesResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return ListCompaniesResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new SequenzyException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
     ...
     * @throws SequenzyApiException
     */
    public function update(string $companyId, UpdateCompaniesRequest $request = new UpdateCompaniesRequest(), ?array $options = null): ?UpdateCompaniesResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return UpdateCompaniesResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new SequenzyException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
