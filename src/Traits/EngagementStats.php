...
use Sequenzy\Types\EngagementStatsRateDenominatorBasis;
 ...
 * @property ?int $rateDenominator
 * @property ?value-of<EngagementStatsRateDenominatorBasis> $rateDenominatorBasis
 * @property ?int $replies
 * @property ?float $replyRate
 * @property ?int $revenueCents
 * @property ?int $sent
 * @property ?int $unsubscribed
 * @property ?float $unsubscribeRate
 */
trait EngagementStats
{
    /**
