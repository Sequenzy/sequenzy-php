...
namespace Sequenzy\Team;

use Psr\Http\Client\ClientInterface;
use Sequenzy\Core\Client\RawClient;
use Sequenzy\Team\Types\CancelInvitationTeamResponse;
...
use Sequenzy\Team\Requests\InviteTeamRequest;
use Sequenzy\Team\Types\InviteTeamResponse;
use Sequenzy\Team\Types\ListTeamResponse;
...
class TeamClient
{
     ...
     * } $options
     * @return ?CancelInvitationTeamResponse
     * @throws SequenzyException
     * @throws SequenzyApiException
     */
    public function cancelInvitation(string $invitationId, ?array $options = null): ?CancelInvitationTeamResponse
    {
        ...
        try {
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return CancelInvitationTeamResponse::fromJson($json);
            }
     ...
     * ```
     *
     * @param InviteTeamRequest $request
     * @param ?array{
     *   baseUrl?: string,
     *   maxRetries?: int,
     *   timeout?: float,
     ...
     * @throws SequenzyApiException
     */
    public function invite(InviteTeamRequest $request, ?array $options = null): ?InviteTeamResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return InviteTeamResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new SequenzyException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
     ...
     * @throws SequenzyApiException
     */
    public function list(?array $options = null): ?ListTeamResponse
    {
        $options = array_merge($this->options, $options ?? []);
        try {
            $response = $this->client->sendRequest(
            ...
            if ($statusCode >= 200 && $statusCode < 400) {
                ...
                return ListTeamResponse::fromJson($json);
            }
        } catch (JsonException $e) {
            throw new SequenzyException(message: "Failed to deserialize response: {$e->getMessage()}", previous: $e);
        } catch (ClientExceptionInterface $e) {
